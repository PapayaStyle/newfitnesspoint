...
@Component({
  ...
  styleUrls: [
    ...
    '../../../manager/staff/manage.staff.css'
  ]
})
export class StaffDialogComponent {
  ...
  initForm() {
    this.staffForm = this.fb.group({
      ...
      description: [this.staff.description, Validators.required],
      image: [this.staff.image, Validators.required],
      portrait: this.staff.portrait,
      showed: this.staff.showed == 1 ? true : false,
  ...
  showHidePreview(value: boolean = null) {
    ...
    if (this.showPreview) {
      ...
      this.staff.description = this.staffForm.controls['description'].value;
